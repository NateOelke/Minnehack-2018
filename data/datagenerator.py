...
with open('exampledata_val.csv', 'w', newline='') as csvfile:
    fieldnames = ['age', 'height', 'weight', 'qb', 'te', 'ot', 'og', 'c', 'rb', 'wr', 'de', 'dt', 'lb', 'cb', 's', 'kp', 'ls',  'years', 'games', 'hours', 'weeks', 'squat', 'bench', 'clean', 'dash', 'exercise', 'concussion_old', 'bone_old', 'ligament_old', 'muscle_old', 'joint_old', 'tendonitis_old', 'sprain_old', 'meniscus_old', 'concussion_new', 'bone_new', 'ligament_new', 'muscle_new', 'joint_new', 'tendonitis_new', 'sprain_new', 'meniscus_new', 'total_new']
